...
### Этап 3 — Скоринг и статусы (неделя)
...
### Этап 4 — Trends Database (страница) (3–5 дней)
...
### Этап 5 — Trend Tracking (Projects) (2–3 дня)
...
### Этап 6 — Курация (в Filament) (1 день, но подключить Filament РАНО — с этапа 0)
